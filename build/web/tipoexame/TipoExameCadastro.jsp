    ...
    <body>
        ...
        <div class="container" style='margin-top:80px'>
            ...
            <div class="well bs-component">
                <legend>Cadastro - Tipo Exame<button class="btn btn-primary btn-sm pull-right" id="btnCadastrar" style="margin-top:-10px">Cadastrar <i class="fas fa-save fa-lg"></i></button> </legend>
                <div class="row">
        ...
        <script>
            ...
            $( "#btnCadastrar" ).click(function() {
                ...
                $.post("../ControllerTipoExame", {
                    option      :   "CadastrarTipoExame",
                    nome        :   $("#nome").val(),
